...
const STAFF_DATA = {
  management: [
    { role: "Vice President for International Affairs", name: "Prof. Yong-Chan KIM (김용찬)", tel: "", email: "" },
    { role: "Associate Vice President & GOSC Executive Director", name: "Prof. Sang Hoon YOUM (염상훈)", tel: "", email: "" },
    { role: "YISS/WAY Chair", name: "Prof. Jon SODERHOLM (존소더홈)", tel: "", email: "" },
  ],
  international: [
    { role: "Director", name: "Ms. Kileun OH (오길은 팀장)", tel: "+82-2-2123-6494", email: "ipartners@yonsei.ac.kr" },
    { role: "Exchange (Europe) Manager", name: "Ms. Seo-Ah CHOI(최서아 과장)", tel: "+82-2-2123-4703", email: "abroad@yonsei.ac.kr" },
    { role: "Exchange (Americas) Manager", name: "Ms. Geeyeon NOH (노지연 대리)", tel: "+82-2-2123-3983", email: "ysoia@yonsei.ac.kr" },
    { role: "Exchange (Asia & Oceania) Manager", name: "Mr. Jongwon KIM (김종원 직원)", tel: "+82-2-2123-4704", email: "sap@yonsei.ac.kr" },
    { role: "Visiting Program Manager", name: "Mr. Sangchan CHUNG (정상찬 대리)", tel: "+82-2-2123-3987", email: "study@yonsei.ac.kr" },
    { role: "Protocol/APRU/AEARU Coordinator", name: "Mr. Jaeyung SHIN (신재영 직원)", tel: "+82-2-2123-4436", email: "protocol@yonsei.ac.kr" },
    ...
    { role: "YISS/WAY Internships Coordinator", name: "Ms. Ga Vin PARK (박가빈 직원)", tel: "+82-2-2123-3988", email: "yissintern@yonsei.ac.kr" },
    { role: "Outgoing Students Assistant", name: "Assistant (조교)", tel: "+82-2-2123-8453", email: "exch@yonsei.ac.kr" },
    { role: "Incoming Students Assistant", name: "Assistant (조교)", tel: "+82-2-2123-3977", email: "study@yonsei.ac.kr" },
    { role: "YISS/WAY Assistant", name: "Assistant (조교)", tel: "+82-2-2123-3535", email: "iwinter@yonsei.ac.kr" },
  ],
  gosc: [
    { role: "Director", name: "Ms. Eunjung LEE (이은정 팀장)", tel: "+82-2123-7371", email: "amber@yonsei.ac.kr" },
    { role: "Student/Faculty Visa (UG) Assoc. Director", name: "Mr. Yong Hwa CHUNG (정용화 차장)", tel: "+82-2-2123-6492", email: "ivisa@yonsei.ac.kr" },
    { role: "Student Visa (Grad) Manager", name: "Ms. Soo Kyung NAM (남수경 주임)", tel: "+82-2-2123-3228", email: "igrad@yonsei.ac.kr" },
    { role: "GKS Program (UG) Manager", name: "Ms. Sumin LEE (이수민 직원)", tel: "+82-2-2123-3488", email: "istudent@yonsei.ac.kr" },
    { role: "Int'l Services Manager", name: "Ms. Dasom KIM(김다솜 주임)", tel: "+82-2-2123-7372", email: "iservice@yonsei.ac.kr" },
    { role: "Service Desk (English) Coordinator", name: "Ms. Eun Saem JUNG (정은샘 직원)", tel: "+82-2-2123-7377", email: "iservice@yonsei.ac.kr" },
    { role: "Service Desk (Chinese) Coordinator", name: "Ms. Leehee KIM (김리희 직원)", tel: "+82-2-2123-7375", email: "iservice@yonsei.ac.kr" },
    { role: "Int'l Student Service Assistant", name: "Assistant (조교)", tel: "82-2-2123-6495", email: "ivisa@yonsei.ac.kr" },
  ]
};
