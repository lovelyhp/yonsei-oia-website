...
const STAFF_DATA = {
  ...
  international: [
    ...
    { role: "Summer/Winter Outbound, Global STERN Coordinator", name: "Ms. Jisun WON (원지선 직원)", tel: "+82-2123-3982", email: "studyabroad@yonsei.ac.kr" },
    ...
    { role: "YISS/WAY Student Assistant", name: "Assistant (YISS/WAY 조교)", tel: "+82-2-2123-3535", email: "iwinter@yonsei.ac.kr, summer@yonsei.ac.kr" },
  ],
  gosc: [
