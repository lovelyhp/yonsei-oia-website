      ...
      <div className="bg-gray-50 border-b border-gray-200 py-8 lg:py-12">
        <div className="container mx-auto px-4 md:px-6">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#003876] font-semibold">Degree Seeking</span>
          </nav>
          <h1 className="text-3xl lg:text-4xl font-bold text-[#003876] tracking-tight">Degree Seeking</h1>
        </div>
      </div>
